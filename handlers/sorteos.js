...
const sorteosSchema = require(`${process.cwd()}/models/sorteos.js`);
const buscarSorteo = async () => {
    const resultado = await sorteosSchema.findOne({ nombre: 'miSorteo' }).maxTimeMS(30000);
